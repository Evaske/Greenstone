...
class FooEvents {
    ...
    public function remove_event_user_caps() {
        ...
        $delete_caps = array(
            ...
            'edit_private_event_magic_tickets', 
            'delete_private_event_magic_tickets', 
            'publish_private_event_magic_tickets', 
            'edit_private_others_event_magic_tickets', 
            );
    ...
    public function get_tab_settings() {
        ...
        $settings = array(
            ...
            'globalWooCommerceEventsAPIKey' => array(
                ...
                'desc'  => __( 'API key used for plugin updates', 'woocommerce-events' )
            ),
            'globalWooCommerceEnvatoAPIKey' => array(
                'name'  => __( 'Envato purchase code', 'woocommerce-events' ),
                'type'  => 'text',
                'id'    => 'globalWooCommerceEnvatoAPIKey',
                'desc'  => __( 'Purchase key used for plugin updates', 'woocommerce-events' )
            ),
    ...
    public function woo_custom_cart_button_text($text) {
        ...
        if (!is_null($product) && $product->managing_stock()) {
             
            if($WooCommerceEventsEvent == 'Event' && $globalWooCommerceEventsChangeAddToCart === 'yes' && $product->is_in_stock()) {
