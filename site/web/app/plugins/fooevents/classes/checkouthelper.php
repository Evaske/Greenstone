...
class FooEvents_Checkout_Helper {
    ...
    public function attendee_checkout($checkout) {
        ...
        echo '<h2 style="margin-top: 20px;">Attendee Details</h2>';
        ...
        foreach($events as $event => $tickets) {
            ...
            if($captureAttendees) {
                ...
                foreach($tickets as $ticket) {
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-12 columns" style="background: #f4f4f4; border-radius: 4px; margin-bottom: 20px; padding: 10px;">';
                  echo '<div style="font-weight: 700;text-align: left;">'.$ticket['event_name'] . ' - Attendee ' . $y . '</div>';
                  echo '<div class="row">';
                    $ticketType = '';
                    ...
                    if($WooCommerceEventsCaptureAttendeeDetails === 'on') {
                      ...
                      echo '<div class="small-12 medium-6 columns">';
                        ...
                        'custom_attributes' => array('tabindex' => $tabindex)
                        );
                        ...
                        if($WooCommerceEventsCaptureAttendeeTelephone === 'on') {
                            ...
                            echo '<label style="text-align:left;">Telephone</label>';
                        ...
                        if($WooCommerceEventsCaptureAttendeeDesignation === 'on') {
                            ...
                            $designationLabel = sprintf(__('Attendee %d Position', 'woocommerce-events'), $y);
                            ...
                            echo '<label style="text-align:left;">Position</label>';
